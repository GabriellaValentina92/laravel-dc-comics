...
<div class="container-create">
  ...
  <form method="POST" action="{{ route('comics.update', ['comic'=> $comic->id]) }}" class="form-create">
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input class="form-control @error('thumb') is-invalid @enderror" id="thumb" rows="3" name="thumb" value="{{ old('thumb', $comic->thumb) }}">
        <div class="invalid-feedback">
